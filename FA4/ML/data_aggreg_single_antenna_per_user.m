...
w_single_user_range = [1, 5]; % have to generate random float value between 1 and 10
...
while idx <= num_samples
    ...
    % minPMAC parameters
    bu_min = datasample(bu_min_single_user_single_tone_range, num_users);
    w = w_single_user_range(1) + (w_single_user_range(2) - ...
        w_single_user_range(1)).*rand(1, num_users);
    ...
    [Eun, theta, bun, FEAS_FLAG, bu_a, info] = minPMAC(H/noise_var, ...
        fft_length*bu_min, w, cb);
