...
while idx <= num_samples
    % try
        ...
        Eun = transmit_power(idx) * eye(num_users);
        ...
        Eu = transmit_power(idx) * ones (1, num_users);
...
% disp(['Linear Only Data Rate: ', num2str(data_samples.bu_a_lin*fft_length)])
% disp(['minPMAC Data Rate: ', num2str(sum(data_samples.bun,2)'*fft_length)])
% disp(['Eun energy: ', num2str(mean(data_samples.Eun, 2)')])
%% Draft
% % Conducts comparison of linear receiver based algorithm with minPMAC
% %
% % get_channel variables:
