...
addpath('channel_files', 'FA4', 'MAC_and_BC', 'single_user', 'tmp', 'utils', ...
    ...
    'FA4/ML/outputs', 'FA4/comparison_models');
...
fft_length_range = 2.^[4:12]; % range of FFT lengths
noise_var = 1.0/90000000;%1.0/30000; % noise variance
...
%     fprintf ("minPMAC finished\n");
    ...
    save('FA4/ML/outputs/Data_SIMO.mat', 'Data_SIMO')
